...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Filippo Danesi ~ SEO & AI Search Manager',
    template: '%s ~ Filippo Danesi',
  },
  description: 'SEO specialist focused on organic search and AI search visibility for enterprise e-commerce. I build tools that automate SEO at scale.',
  ...
  openGraph: {
    ...
    title: 'Filippo Danesi ~ SEO & AI Search Manager',
    description: 'SEO specialist focused on organic search and AI search visibility for enterprise e-commerce. I build tools that automate SEO at scale.',
    images: [
      {
        url: '/api/og',
        width: 1200,
        height: 630,
        alt: 'Filippo Danesi ~ SEO & AI Search Manager',
      },
    ],
  },
  twitter: {
